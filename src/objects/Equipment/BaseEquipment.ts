import { EquipmentCategory, EquipmentMaster } from '../../data'
...
export interface IEquipmentBase extends IEquipmentStats {
  /** 装備ID */
  masterId: number
  name: string
...
export default class EquipmentBase implements IEquipmentBase {
  constructor(
    private readonly master: EquipmentMaster,
